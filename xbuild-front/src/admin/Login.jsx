...
export default function Login() {
  ...
  return (
    <div style={{ minHeight:"100vh", display:"flex", background:"#0f1422", fontFamily:"'Barlow', sans-serif", overflow:"hidden" }}>
      <style>{`
      ...
      <div className="login-mobile-header" style={{
        ...
        background: "#131928", borderBottom: "3px solid #e8a000",
        padding: "12px 20px", alignItems: "center", gap: 10, zIndex: 10,
      }}>
        <div style={{ width: 3, height: 24, background: "#e8a000" }} />
        <span style={{ fontFamily: "'Barlow Condensed'", fontSize: 22, fontWeight: 900, color: "#fff", letterSpacing: 2, textTransform: "uppercase" }}>
          X<span style={{ color: "#e8a000" }}>BUILD</span>
        </span>
        <span style={{ marginLeft: "auto", fontFamily: "'Barlow Condensed'", fontSize: 11, fontWeight: 800, color: "rgba(255,255,255,.3)", letterSpacing: 2, textTransform: "uppercase" }}>
          Administration
        </span>
      </div>
      ...
      <div className="login-form-side">
        <div style={{ width:"min(420px, 100%)", animation:"fadeUp .4s ease" }}>
